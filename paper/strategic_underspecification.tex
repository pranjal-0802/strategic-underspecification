...
$c(m)$ relative to $V$. Crucially, an extensive follow-up finite-difference
audit across 2,552 parameter intervals confirms that $m^*(g)$ remains weakly
decreasing in $g$ in $100\%$ of tested intervals outside the sufficient condition
($2{,}162/2{,}162$), demonstrating that monotonicity of specification survives
universally across the working range even when Assumption~\ref{ass:reg} is
violated.
\end{remark}
